...
public class OrbitalChemistry : MonoBehaviour
{
    ...
    void Update()
    {
        dotPrefab.transform.Rotate(30 * Time.deltaTime, 100 * Time.deltaTime, 30 * Time.deltaTime);
        //target.transform.Rotate(0, 100 * Time.deltaTime, 0);
        transform.RotateAround (point,new Vector3(1.0f,1.0f,0.0f),20 * Time.deltaTime * speedMod);
    }
}
